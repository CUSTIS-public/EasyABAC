...
public abstract class EasyAbacBaseDynamicRulesTestClass {
    ...
    public EasyAbacBaseDynamicRulesTestClass(InputStream modelSource) throws EasyAbacInitException {
        EasyAbacModelCreator creator = new EasyAbacModelCreator();
        this.model = creator.createModel(modelSource);
    }

    public EasyAbacBaseDynamicRulesTestClass(AbacAuthModel model) {
        this.model = model;
    }
