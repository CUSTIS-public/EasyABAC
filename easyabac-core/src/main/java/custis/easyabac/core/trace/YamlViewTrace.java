...
public class YamlViewTrace implements Trace {

    public static final Logger LOGGER = LoggerFactory.getLogger(YamlViewTrace.class);
    public static final Trace INSTANCE = new YamlViewTrace();
