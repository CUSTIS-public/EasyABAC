...
public class BalanaTimeFunctions implements BalanaFunctions {
    ...
    public Function oneOf() {
        return new ConditionSetFunction("urn:oasis:names:tc:xacml:1.0:function:time-at-least-one-member-of");
    }

    @Override
    public Function subset() {
        return new ConditionSetFunction("urn:oasis:names:tc:xacml:1.0:function:time-subset");
    }
