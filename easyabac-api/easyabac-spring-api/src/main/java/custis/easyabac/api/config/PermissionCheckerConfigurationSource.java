 ...
 */
public interface PermissionCheckerConfigurationSource {
	 ...
	 */
	Optional<String> getPermissionCheckerImplementationPostfix();
	 ...
	 * @return
	 */
	Optional<String> getPermissionCheckerFactoryBeanClassName();
