...
public class PermissionCheckerBeanNameGenerator {

	private static final AnnotationBeanNameGenerator DELEGATE = new AnnotationBeanNameGenerator();
	...
	public String generateBeanName(BeanDefinition definition) {
		...
		AnnotatedBeanDefinition beanDefinition = definition instanceof AnnotatedBeanDefinition //
				...
				: new AnnotatedGenericBeanDefinition(getPermissionCheckerInterfaceFrom(definition));
	 ...
	 * @return
	 */
	private Class<?> getPermissionCheckerInterfaceFrom(BeanDefinition beanDefinition) {
