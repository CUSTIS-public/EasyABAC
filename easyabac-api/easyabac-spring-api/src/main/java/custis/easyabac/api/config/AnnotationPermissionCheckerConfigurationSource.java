...
/**
 * Annotation based {@link BasePermissionCheckerConfigurationSource}.
 * 
 * @author Anton Lapitskiy
 */
public class AnnotationPermissionCheckerConfigurationSource extends BasePermissionCheckerConfigurationSource {

	private static final String PERMISSION_CHECKER_IMPLEMENTATION_POSTFIX = "permissionCheckerImplementationPostfix";
	private static final String BASE_PACKAGES = "basePackages";
	private static final String BASE_PACKAGE_CLASSES = "basePackageClasses";
	private static final String PERMISSION_CHECKER_FACTORY_BEAN_CLASS = "permissionCheckerFactoryBeanClass";
	private static final String PERMISSION_CHECKER_BASE_CLASS = "permissionCheckerBaseClass";
	...
	/**
	 * Creates a new {@link AnnotationPermissionCheckerConfigurationSource} from the given {@link AnnotationMetadata} and
	 * annotation.
	 *
	 ...
	 */
	public AnnotationPermissionCheckerConfigurationSource(AnnotationMetadata metadata, Class<? extends Annotation> annotation,
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.repository.config.RepositoryConfigurationSource#getPermissionCheckerImplementationPostfix()
	 */
	public Optional<String> getPermissionCheckerImplementationPostfix() {
		return getNullDefaultedAttribute(PERMISSION_CHECKER_IMPLEMENTATION_POSTFIX);
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.repository.config.RepositoryConfigurationSource#getPermissionCheckerFactoryBeanClassName()
	 */
	@Override
	public Optional<String> getPermissionCheckerFactoryBeanClassName() {
		return Optional.of(attributes.getClass(PERMISSION_CHECKER_FACTORY_BEAN_CLASS).getName());
	}

	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.repository.config.RepositoryConfigurationSource#getPermissionCheckerBaseClassName()
	 */
	@Override
	public Optional<String> getPermissionCheckerBaseClassName() {

		if (!attributes.containsKey(PERMISSION_CHECKER_BASE_CLASS)) {
			return Optional.empty();
		}

		Class<? extends Object> permissionCheckerBaseClass = attributes.getClass(PERMISSION_CHECKER_BASE_CLASS);
		return DefaultPermissionCheckerBaseClass.class.equals(permissionCheckerBaseClass) ? Optional.empty()
				: Optional.of(permissionCheckerBaseClass.getName());
	}
